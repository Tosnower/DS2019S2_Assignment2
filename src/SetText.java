...
public class SetText {
	...
	private void initialize() {
		...
		textField.setBounds(114, 28, 150, 20);
		...
		fontSelector.setFont(new Font("ºÚÌå", Font.PLAIN, 12));
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				model.setBounds(20, 20, temp*40+20, 120);
		...
		btnConfirm.setBounds(149, 114, 75, 23);
